...
def show_title():
    ...
    logger.info("Application title displayed.")
...
def show_supported_databases():
    ...
    """)
    logger.info("Displayed supported databases.")
...
def determine_dialect(db_url):
    ...
    logger.info(f"Database dialect set to: {st.session_state.dialect}")
...
def convert_and_run_query(nl_query):
	...
	# Generate SQL from the natural language query
	    ...
	    # Validate the generated SQL query	
            if validate_sql(sql_query):
                ...
                if translated_query:
                    ...
                    logger.info(f"Translated SQL Query: {translated_query}")
        ...
        logger.warning("Empty natural language query received.")
